...
void sampleFunction(double (*f_p)(double x, double y), double z[N_PIXEL_1D][N_PIXEL_1D])
...
// [-1,1] x [-1,1] */
{
     ...
     *    z -- output N_PIXEL_1D x N_PIXEL_1D array of values of f
