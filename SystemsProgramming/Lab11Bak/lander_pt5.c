...
/*
*	If there's an environment variable named 'envName', convert it to a double and return it. Otherwise, return the default value 'dflt'.
*
*/
{
...
int main(int argc, char *argv[])
{
	...
	struct option lopts[5] = 
	{
		...
		{"max-thrust", 2, 0, 't'},
		{"initial-fuel", 2, 0, 'f'},
		{"initial-height", 2, 0, 'h'},
		{"initial-velocit", 2, 0, 'v'},
	};
	...
	while((optionLetter = getopt_long(argc, argv, "t:f:g:h:v:", lopts, NULL)) != -1)
	{
		switch(optionLetter)
		{
		case 't':
